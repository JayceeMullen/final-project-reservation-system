...
public class ReservationsDao : IReservationsDao
{
    ...
    {
        const string query = "INSERT INTO Reservations (LocationID, CustomerID, NumberOfGuests, ReservationStartTime, ReservationEndTime) VALUES (@LocationID, @CustomerID, @NumberOfGuests, @Start, @End)";
        using IDbConnection connection = _context.CreateConnection();
